...
3. Install [**Timezone_Generic** library](https://platformio.org/lib/show/xxxxx/Timezone_Generic) by using [Library Manager](https://platformio.org/lib/show/xxxxx/Timezone_Generic/installation). Search for UPnP_Generic in [Platform.io Author's Libraries](https://platformio.org/lib/search?query=author:%22Khoi%20Hoang%22)
